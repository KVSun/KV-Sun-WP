...
function begin_file($file = null)
{
    if(is_string($file) and defined('KVSun\DEBUG_MODE') and KVSun\DEBUG_MODE) {
        echo sprintf('<!--BEGIN: "%s"-->' . PHP_EOL, str_replace(__DIR__, null, $file));
    }
}

function end_file($file = null)
{
    if(is_string($file) and defined('KVSun\DEBUG_MODE') and KVSun\DEBUG_MODE) {
        echo sprintf('<!--END: "%s"-->' . PHP_EOL, str_replace(__DIR__, null, $file));
    }
}
