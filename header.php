...
<base href="/"/>
	...
	<?php if(is_single()){ ?>
		...
		<!--meta itemprop="description" name="description" content="<?php ob_start();
		the_content();
		$old_content = ob_get_clean();
		$new_content = strip_tags($old_content);
		echo $new_content; ?>" />
		<meta itemprop="keywords" name="keywords" content="<?php the_title(); ?>" /-->
	...
	<?php }else{ ?>
		...
		<!--meta itemprop="description" name="description" content="A custom theme for the Kern Valley Sun Wordpress site." />
		<meta itemprop="keywords" name="keywords" content="Wordpress theme, KV Sun, flex" /-->
	<?php } ?>
...
<title>
<?php the_title();//wp_title( '|', true, 'right' ); ?>
</title>
...
<div id=""><!--<div id="wrapper-container">-->
<div id="header">
