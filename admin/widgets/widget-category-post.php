				...
				<ul class="sb-tabs-wrap">
 				...
 				'cat' => $get_catego,
					...
					<li>
						...
						<?php } else { ?>
							<a href="<?php the_permalink(); ?>" rel="bookmark" title="<?php the_title(); ?>"><img src="<?php echo get_template_directory_uri() . DEFAULT_IMAGE; ?>" width="60" height="60" alt="<?php the_title(); ?>" /></a>
						<?php } ?>
						</div>
